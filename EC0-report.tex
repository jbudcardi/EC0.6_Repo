...
\lhead{\small EC 0.6 - Reports, Cartwright}  % EDIT THIS, REPLACE # with HW number
...
\begin{figure}[h!]
    ...
    \includegraphics[trim=0 20 10 50, clip, width=\textwidth] {tux.png}
    \caption{Tux the Linux Penguin}
...
\begin{lstlisting}[language=Python, caption=Python print example string, label=lst:copy]
...
3 & Sep 7 & Measuring the Web \\ \hline
4 & Sep 14 & Searching the Web \\ \hline
\end{tabular}
\end{table}
...
\begin{itemize}
    \item {Overleaf, Git Integration and GitHub Synchronization, \url{https://www.overleaf.com/learn/how-to/Git_Integration_and_GitHub_Synchronization}}
    \item{Communications of the ACM, Web Science: An Interdisciplinary Approach to Understanding the Web, \url{https://cacm.acm.org/research/web-science/}}
    \item {YouTube, What is Web Science,
    \url{https://www.youtube.com/watch?v=demjTp3A55A}}
\end{itemize}
