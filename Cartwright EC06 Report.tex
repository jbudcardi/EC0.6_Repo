...
\begin{figure}[h!]
    ...
    \includegraphics[trim=0 20 10 50, clip, width=\textwidth] {growth-early-web.png}
    \caption{Growth of the early Web}
...
1 & Sep 1, 3 & Introduction, What's Vis and Why Do It? \\ \hline
2 & Sep 8, 10 & Data and Data Cleaning \\ \hline
3 & Sep 15, 17 & Marks and Channels \\ \hline
\end{tabular}
\end{table}
...
\begin{itemize}
    \item {Stack Overflow, How can I parse (read) and use JSON in Python?, \url{https://stackoverflow.com/questions/7771011/how-can-i-parse-read-and-use-json-in-python}}
    \item{ChatGPT conversation, Initial prompt: "write a python line to detect if a string ends with .png", \url{https://chat.openai.com/share/5de76e93-c26b-4665-a0fc-b782b01a9285}}
\end{itemize}
